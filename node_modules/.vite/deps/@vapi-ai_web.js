...
function B(e2) {
  return null != e2 && e2.callObjectBundleUrlOverride ? e2.callObjectBundleUrlOverride : F("https://c.daily.co/call-machine/versioned/".concat("0.84.0", "/static/call-machine-object-bundle.js"), e2);
}
function U(e2) {
  try {
    new URL(e2);
      ...
      async start(assistant, assistantOverrides, squad, workflow, workflowOverrides) {
        ...
        try {
          ...
          this.emit("call-start-failed", {
            stage: "unknown",
            totalDuration,
            error: e2?.toString() || "Unknown error occurred",
            errorStack: e2 instanceof Error ? e2.stack : "No stack trace available",
            timestamp: (/* @__PURE__ */ new Date()).toISOString(),
            context: {
              hasAssistant: !!assistant,
              hasSquad: !!squad,
