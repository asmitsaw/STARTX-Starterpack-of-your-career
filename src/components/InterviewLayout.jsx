      ...
      <div className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
        ...
        <div className="p-4 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-bold text-slate-100">AI Interviewer</h2>
        ...
        {/* Main Menu */}
        <div className="p-4">
          <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">MAIN MENU</h3>
        ...
        <div className="mt-auto p-4 border-t border-slate-800">
          <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">QUICK STATS</h3>
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-slate-300">Active Interviews</p>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-slate-300">Completed Today</p>
