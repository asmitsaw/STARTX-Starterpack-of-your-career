          ...
          <div className="relative search-container" onClick={(e) => e.stopPropagation()}>
            <div className="relative">
              <input
                ...
                className="w-64 px-4 py-2 rounded-full bg-white/10 text-white placeholder-white/50 border border-white/20 focus:outline-none focus:ring-2 focus:ring-startx-500/50"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                onFocus={() => {
                  setShowSearchResults(true);
                  setSearchError(null); // Clear any previous errors when focusing
                }}
              />
