...
const ProfileCardComponent = ({
  ...
  useEffect(() => {
    ...
    if (mq && mq.matches) setMotionOk(false);

    if (!enableTilt || !animationHandlers || !motionOk) return;
    ...
    <div ref={wrapRef} className={`pc-card-wrapper ${className}`.trim()} style={cardStyle}>
      <section ref={cardRef} className="pc-card">
        <div className="pc-inside">
          ...
          {showUserInfo && (
            <div className="pc-user-info" role="contentinfo" aria-label="Contact section">
              <div className="pc-status-row" aria-live="polite">
